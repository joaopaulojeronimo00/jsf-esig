...
public class CriaTarefas {
	...
	public static void main(String[] args) throws ParseException {
		...
		t4.setDescricao("Descriçasdfasdfasdfasdfasdfão 4");
		t4.setResponsavel("Amanda");
